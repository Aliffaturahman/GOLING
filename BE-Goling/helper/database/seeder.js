...
async function SeederDestination() {
  const destinations = [
    {
      name: "Danau Toba",
      description:
    ...
    },
    {
      ...
      imageUrls: [
        "https://storage.googleapis.com/kzquandary/goling/bali1.jpg",
        "https://storage.googleapis.com/kzquandary/goling/bali2.jpg",
      ],
    },
    {
      name: "Raja Ampat",
  ...
  for (const destination of destinations) {
    ...
    if (!existingDestination) {
      ...
      for (const imageUrl of destination.imageUrls) {
      ...
      console.log(`Destination ${destination.name} already exists.`);
    }
  }
}
